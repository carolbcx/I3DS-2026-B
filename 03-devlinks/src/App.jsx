...
function App() {
  ...
  return (
    <div id="App" className={isLight ? "light" : ""}>
      <Perfil fotoPerfil={foto}>Caroline Barbosa</Perfil>
      ...
      <div id="SocialLinks">
        <SocialLink url={"https://github.com/carolbcx/"} icon={"logo-github"} />
        <SocialLink url={"https://instagram.com/carolinebcx_/"} icon={"logo-instagram"} />
